# Task 9 Review Package（3f4928f..HEAD）
...
## Diff stat
 examples/vite/README.md                     |   4 +-
 website/src/nav.ts                          |   1 +
 website/src/pages/guides/WebIntegration.css |  59 +++++
 website/src/pages/guides/WebIntegration.tsx | 374 ++++++++++++++++++++++++++++
 website/src/routes.ts                       |   2 +
 5 files changed, 438 insertions(+), 2 deletions(-)

## 完整 diff（website 新页 + 注册 + examples/vite README M1）
diff --git a/examples/vite/README.md b/examples/vite/README.md
index 0240947..f89a28f 100644
--- a/examples/vite/README.md
+++ b/examples/vite/README.md
@@ -46,18 +46,18 @@ npm run preview
 [vane] 已关闭
 ```
...
diff --git a/website/src/nav.ts b/website/src/nav.ts
index ee7d6aa..3ec84dc 100644
--- a/website/src/nav.ts
+++ b/website/src/nav.ts
@@ -21,16 +21,17 @@ export const docsNav: NavSection[] = [
   },
   {
     title: 'Guides',
     items: [
...
diff --git a/website/src/pages/guides/WebIntegration.css b/website/src/pages/guides/WebIntegration.css
new file mode 100644
index 0000000..f9640f0
--- /dev/null
+++ b/website/src/pages/guides/WebIntegration.css
@@ -0,0 +1,59 @@
+/* Web Integration guide page (T9). Prefix: webint- */
+
+.webint-page h1 {
...
+}
+
+/* Config-item tables (vite / webpack): compact reference. */
+
+.webint-table {
+  width: 100%;
...
+}
+
+/* Stack Callouts in the gotchas section with a tighter gap. */
+
+.webint-callouts {
+  display: flex;
...
+  margin: var(--space-4) 0 var(--space-5);
+}
diff --git a/website/src/pages/guides/WebIntegration.tsx b/website/src/pages/guides/WebIntegration.tsx
new file mode 100644
index 0000000..96a0654
--- /dev/null
+++ b/website/src/pages/guides/WebIntegration.tsx
@@ -0,0 +1,374 @@
...
@@ -26,16 +27,17 @@ export interface RouteDef {
  */

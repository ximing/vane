...
+fault-injection = []
 ...
 [[bench]]
 name = "batch_add"
diff --git a/crates/vane-core/src/vfs/fault.rs b/crates/vane-core/src/vfs/fault.rs
new file mode 100644
index 0000000..00549ad
--- /dev/null
+++ b/crates/vane-core/src/vfs/fault.rs
@@ -0,0 +1,565 @@
...
+    }
+}
diff --git a/crates/vane-core/src/vfs/mod.rs b/crates/vane-core/src/vfs/mod.rs
index 66327b2..8457e1e 100644
--- a/crates/vane-core/src/vfs/mod.rs
+++ b/crates/vane-core/src/vfs/mod.rs
@@ -10,13 +10,17 @@ pub trait Vfs: Send + Sync {
     fn sync(&self, path: &str) -> Result<()>;
     fn rename(&self, from: &str, to: &str) -> Result<()>;
     fn delete(&self, path: &str) -> Result<()>;
     fn list(&self, dir: &str) -> Result<Vec<String>>;
